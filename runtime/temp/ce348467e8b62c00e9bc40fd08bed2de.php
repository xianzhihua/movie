<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:70:"C:\wamp\www\tp5movie\public/../application/index\view\index\index.html";i:1531207053;s:59:"C:\wamp\www\tp5movie\application\index\view\common\top.html";i:1529057787;s:62:"C:\wamp\www\tp5movie\application\index\view\common\footer.html";i:1530244675;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="UTF-8">
...
<div class="container">
	<blockquote><h4>电影 <a href="<?php echo url('more/index',array('classid'=>'1')); ?>" class="pull-right">查看更多</a></h4></blockquote>
	<div class="row">
		<?php if(is_array($movie) || $movie instanceof \think\Collection || $movie instanceof \think\Paginator): $i = 0; $__LIST__ = $movie;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$movies): $mod = ($i % 2 );++$i;?>
		<div class="col-xs-6 col-sm-4 col-md-3 col-lg-2">
			<a href="<?php echo url('video/index',array('id'=>$movies['id'])); ?>" target="_blank">
			<div class="col-img">
				<div>
					<div class="icon"></div>
					<img src="<?php echo $movies['img']; ?>">
					<?php if($movies['num']): ?>
						<p><?php echo $movies['num']; ?></p>
					<?php endif; ?>
				</div>
				<p><?php echo $movies['title']; ?></p>
		        <?php if($movies['des']): ?>
		        	<p><?php echo $movies['des']; ?></p>
		        <?php else: ?>
					<p>无描述</p>
		        <?php endif; ?>
				<p class="score"><?php echo $movies['score']; ?></p>
			</div>
			</a>
		</div>
...
<div class="container">
	<blockquote><h4>电视 <a href="<?php echo url('more/index',array('classid'=>'2')); ?>" class="pull-right">查看更多</a></h4></blockquote>
	<div class="row">
		<?php if(is_array($dianshi) || $dianshi instanceof \think\Collection || $dianshi instanceof \think\Paginator): $i = 0; $__LIST__ = $dianshi;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$movies): $mod = ($i % 2 );++$i;?>
		<div class="col-xs-6 col-sm-4 col-md-3 col-lg-2">
			<a href="<?php echo url('video/index',array('id'=>$movies['id'])); ?>" target="_blank">
			<div class="col-img">
				<div>
...
<div class="container">
	<blockquote><h4>动漫 <a href="<?php echo url('more/index',array('classid'=>'3')); ?>" class="pull-right">查看更多</a></h4></blockquote>
	<div class="row">
		<?php if(is_array($donman) || $donman instanceof \think\Collection || $donman instanceof \think\Paginator): $i = 0; $__LIST__ = $donman;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$movies): $mod = ($i % 2 );++$i;?>
		<div class="col-xs-6 col-sm-4 col-md-3 col-lg-2">
			<a href="<?php echo url('video/index',array('id'=>$movies['id'])); ?>" target="_blank">
			<div class="col-img">
				<div>
...
<div class="footer">
	<a href="http://www.miitbeian.gov.cn/">粤ICP备18070364号-2</a>
</div>
</body>
</html>