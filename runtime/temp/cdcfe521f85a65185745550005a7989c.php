<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:69:"C:\wamp\www\tp5movie\public/../application/index\view\more\index.html";i:1530796688;s:59:"C:\wamp\www\tp5movie\application\index\view\common\top.html";i:1529057787;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="UTF-8">
...
$('.load_more').on('click', function () {
	...
	$.ajax({
		url : "<?php echo url('index/more/index'); ?>",
		type : 'POST',
		data : {
			page : page,
		...
		success : function (response, status) {
			...
			$.each(json, function (index, value) {
				...
				div+='	<a href="<?php echo url('video/index'); ?>?id='+value.id+'" target="_blank">';
